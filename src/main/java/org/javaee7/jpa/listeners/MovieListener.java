...
public class MovieListener {
    ...
    @PostLoad
    public void newMovieLoad(MovieL movie) {
    ...
    @PrePersist
    public void newMovieAlertBefore(MovieL movie) {
    ...
    @PostPersist
    public void newMovieAlertAfter(MovieL movie) {
    ...
    @PreUpdate
    public void updateMovieAlertBefore(MovieL movie) {
    ...
    @PostUpdate
    public void updateMovieAlertAfter(MovieL movie) {
    ...
    @PreRemove
    public void deleteMovieAlertBefore(MovieL movie) {
    ...
    @PostRemove
    public void deleteMovieAlertAfter(MovieL movie) {
